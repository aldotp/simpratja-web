<x-dashboard-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <x-ui.card class="mt-2">
            ...
            <form action="{{ route('doctor.medicines.update', $medicine->id) }}" method="POST" class="space-y-4 mt-4">
                @csrf
                @method('PUT')
                ...
                <x-form.input name="expiry_date" id="expiry_date" label="Tanggal Kadaluarsa" type="date"
                    placeholder="Pilih Tanggal Kadaluarsa" required :value="old('expiry_date', $medicine->expiry_date)" />
