                ...
                <div class="relative z-10 p-6 md:p-8">
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between w-full">
                        ...
                        <div class="mb-6 md:mb-0 animate-slide-right animate-delay-100">
                            ...
                            <p class="text-gray-600 mt-3">Welcome to your personal healthcare dashboard. We're here to
                                help you manage your health journey with ease.</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 animate-slide-up animate-delay-300">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <!-- Medical Record Count Card -->
                            <div class="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-600">Total Medical Records</p>
                                        <h4 class="text-2xl font-bold text-gray-900 mt-1">{{ $medicalRecordCount }}</h4>
                                    </div>
                                    <div class="bg-primary-100 p-3 rounded-full">
