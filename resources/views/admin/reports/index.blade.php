    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <x-ui.card class="mt-2">
            <div class="flex justify-between items-center mb-4">
                ...
                <x-form.button class="!py-2 !px-2.5" onclick="window.location.href='{{ route('admin.reports.create') }}'">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <x-form.button class="!py-2 !px-2.5" variant="info"
                                    onclick="window.location.href='{{ route('admin.reports.show', $report->id) }}'">
